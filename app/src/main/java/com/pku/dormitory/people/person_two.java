...
/**
 * Created by Tammy on 2017/12/17.
 */

public class person_two extends Activity implements View.OnClickListener {
    private int a;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.persontwo);
    ...
    void initViews() {
        ...
        sp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                ((MyApplication)getApplication()).setBuildnum(select1);
