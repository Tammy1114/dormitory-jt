...
public class person_four extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.personfour);
        nu = (TextView) findViewById(R.id.xuehao1);
        nam = (TextView) findViewById(R.id.xingming1);
        genderTV = (TextView) findViewById(R.id.xingbie1);
        stu1id = (EditText) findViewById(R.id.stu4_1);
        v1code = (EditText) findViewById(R.id.v4code_1);
        stu2id = (EditText) findViewById(R.id.stu4_2);
        v2code = (EditText) findViewById(R.id.v4code_2);
        stu3id = (EditText) findViewById(R.id.stu4_3);
        v3code = (EditText) findViewById(R.id.v4code_3);
    ...
    public void onClick(View view) {
        ...
        final String stu3 = stu3id.getText().toString();
        final String v3cd = v3code.getText().toString();
                if (TextUtils.isEmpty(stu1) || TextUtils.isEmpty(stu2) || TextUtils.isEmpty(stu3)) {
                    Toast.makeText(getApplicationContext(), "学号不能为空", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(v1cd) || TextUtils.isEmpty(v2cd)|| TextUtils.isEmpty(v3cd)) {
                    Toast.makeText(getApplicationContext(), "验证码不能为空", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(stu1.trim()) || TextUtils.isEmpty(v1cd.trim()) || TextUtils.isEmpty(stu2.trim()) || TextUtils.isEmpty(v2cd.trim()) || TextUtils.isEmpty(stu3.trim()) || TextUtils.isEmpty(v3cd.trim())){
                    ...
                    params.put("stu3id",stu3);
                    params.put("v3code",v3cd);
    ...
    void initViews() {
        ...
        final Spinner sp = (Spinner) findViewById(R.id.select3);
        sp.setAdapter(adapter);
        sp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            // parent： 为控件Spinner view：显示文字的TextView position：下拉选项的位置从0开始
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                TextView tvResult = (TextView) findViewById(R.id.buildinga);
                //((MyApplication)getApplication()).setBuildnum(tvResult);
                //获取Spinner控件的适配器
                select3 = (String) sp.getSelectedItem();
                //int i = Integer.parseInt(select3);
                ((MyApplication)getApplication()).setBuildnum(select3);
